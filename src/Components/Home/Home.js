...
const Home = () => {
  ...
  return (
    <>
      ...
      <section id="testimonials2" class="testinomials developer">
        <div class="devloper">
          <h3 class="">Contact Developer</h3>
        </div>
        <div class="dev">
          <div class="dev_items">
            <a
              href="https://wa.me/916305945730"
              target="_blank"
              rel="noreferrer"
            >
              <div class="icon">
          ...
          <div class="dev_items">
            <a
              href="mailto:syedfaizuddin506@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
              <div class="icon">
          ...
          <div class="dev_items">
            <a
              href="https://bespoke-elf-214ab1.netlify.app/"
              target="_blank"
              rel="noreferrer"
            >
              <div class="icon">
